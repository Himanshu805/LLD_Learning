...
🧩 Problem Statement:
Your company manages a burger inventory system. Multiple modules (e.g., Website, Mobile App, Admin Dashboard) need to
be notified immediately and independently whenever the stock of burgers changes.
