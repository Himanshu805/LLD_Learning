...
class SoldierAsset{
    //  Intrinsic state or Shared properties
...
// Pros :
// Memory Efficiency: Intrinsic state or Shared properties (weapon, image, health) are stored in a single SoldierAsset class, reducing memory usage.
